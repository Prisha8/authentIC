...
function initDarkMode() {
  const savedTheme = localStorage.getItem('authentIC_theme') || 'light';
...
function applyTheme(theme) {
  ...
  localStorage.setItem('authentIC_theme', theme);
}
...
function toggleDarkMode() {
  const currentTheme = localStorage.getItem('authentIC_theme') || 'light';
